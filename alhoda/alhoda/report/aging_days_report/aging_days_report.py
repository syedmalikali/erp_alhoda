...
class ReceivablePayableReport:
	...
	def get_columns(self):
		self.columns = []
		self.add_column(label=_("Cost Center"), fieldname="cost_center", fieldtype="Data",width=80)
		self.add_column("Posting Date", fieldtype="Date",width=110)
		...
		self.add_column(label=_("Customer LPO"), fieldname="po_no", fieldtype="Data",width=150)
